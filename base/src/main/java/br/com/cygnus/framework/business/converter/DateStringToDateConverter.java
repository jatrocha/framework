 ...
 */
public class DateStringToDateConverter implements Converter<String, DateTime> {
   ...
   public DateTime convert(String source) {
      ...
      return DateTimeFormat.forPattern(IConstantes.PATTERN_DD_MM_YYYY).parseDateTime(source);
   }
